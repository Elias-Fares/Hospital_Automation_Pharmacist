class Res {
  ...
  static const String successfulVerification =
      "$authImagePath/successful_verification$svg";
  static const String permissionRequired = "$authImagePath/per_req$png";
  ...
  static const String barcodeIcon = "$mainScreenIconPath/barcode$png";
  ...
  static const String inventoryIcon = "$drawerIconPath/d_inventory$svg";
  static const String statsIcon = "$drawerIconPath/d_stats$svg";
  static const String ordersIcon = "$drawerIconPath/d_orders$svg";
  static const String pricesIcon = "$drawerIconPath/d_prices$svg";
